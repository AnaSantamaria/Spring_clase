...
public class ResultadosDaoImpl implements ResultadosDao {
	...
	public void save(Resultado resultado) {
		String sql="insert into resultados(url,temática,descripcion) values(?,?,?)";
	...
	public Resultado findByUrl(String url) {
		...
		List<Resultado> resultados =template.query(sql, mapper,url);  //// El metodo query devuelve una lista siempre
